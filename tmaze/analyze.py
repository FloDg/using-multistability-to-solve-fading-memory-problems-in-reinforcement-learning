...
# This script runs a game on the T-maze environment and retains the hidden
...
env = TMaze(corridor_length, init=init, render=render, print_end=True)
...
while True:
    ...
    # If using double layer model, extract hidden state of warmed up cell
    if Model == DoubleLayerModel:
        h = h[1]
